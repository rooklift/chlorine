...
Finally, if you're on Windows, and desperate, there's a prebuilt binary in the Releases section, though it's not really adequately tested. (For one thing, it uses an older version of Electron.)
